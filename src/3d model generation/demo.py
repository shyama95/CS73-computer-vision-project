...
SPH_REGS_MALE_PATH = 'models/regressors_locked_normalized_male.npz'
SPH_REGS_FEMALE_PATH = 'models/regressors_locked_normalized_female.npz'
MODEL_MALE_PATH = 'models/basicmodel_m_lbs_10_207_0_v1.0.0.pkl'
MODEL_FEMALE_PATH = 'models/basicModel_f_lbs_10_207_0_v1.0.0.pkl'
...
# Paste the data from "src/keypoint estimation/out_keypoints.txt" file
joints_14_2 = np.array([(306, 834), (306, 667), (292, 500), (347, 500), (347, 667), (333, 793), (222, 480), (236, 375), (250, 271), (417, 271), (417, 396), (389, 500), (333, 229), (347, 125)])
confidence_14 = np.array([0.6584314703941345, 0.6909972429275513, 0.6588402390480042, 0.43828341364860535, 0.56292724609375, 0.612441897392273, 0.7628844380378723, 0.8810522556304932, 0.7926936745643616, 0.758188009262085, 0.6806609630584717, 0.701092004776001, 0.8709067106246948, 0.7386004328727722])

params, vis = run_single_fit(image, joints_14_2, confidence_14, model_male, regs=sph_regs_male, n_betas=n_betas, flength=flength, pix_thsh=pix_thsh, scale_factor=2, viz=viz, do_degrees=do_degrees)
...
with open('params', 'w') as outf:
    pickle.dump(params, outf)

cv2.imwrite('3d_model.png', vis[0])
